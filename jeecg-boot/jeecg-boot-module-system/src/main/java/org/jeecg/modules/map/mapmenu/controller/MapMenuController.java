package org.jeecg.modules.map.mapmenu.controller;
...
import org.jeecg.modules.map.mapmenu.entity.MapMenu;
import org.jeecg.modules.map.mapmenu.service.IMapMenuService;
...
public class MapMenuController {
	...
	@PermissionData(pageComponent="map/MapMenuList")
	...
	// 	return result;
	// }
	public Result<List<MapMenu>> list(MapMenu mapMenu,HttpServletRequest req) {
		Result<List<MapMenu>> result = new Result<List<MapMenu>>();
		QueryWrapper<MapMenu> queryWrapper = QueryGenerator.initQueryWrapper(mapMenu, req.getParameterMap());
		List<MapMenu> list = mapMenuService.list(queryWrapper);
		result.setSuccess(true);
